...
variable : VARIABLE ID EQUALS value END; //requires VAR token followed by ID token followed by EQUALS TOKEN ...
print : PRINT ID END; //print statement must consist of 'print' keyword and ID
value : op=NUMBER
...
END : ';' ; //must be any alphanumeric value
